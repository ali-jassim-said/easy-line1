<template>
        ...
        <div class="table-data">
          <div class="order">
            <div class="head">
              ...
              <router-link :to="{ name: 'addCaptain'}"><button type="button" class="btn btn-primary">Add Captain</button></router-link>
            </div>
            <table v-if="captains.length > 0">
              ...
              <tbody>
                <tr v-for="captain in captains" :key="captain.id">
                  <td>
                    <p>{{ captain.name }}</p>
                  </td>
                  <td>
                ...
                <td><router-link :to="{ name: 'getCaptain', params: { id: captain.id}}"><button type="button" class="btn btn-info">inf</button></router-link></td>
  ...
  export default {
    ...
    mounted() {
      this.$store.dispatch("getCaptains");
    },
    computed:{
      captains() {
